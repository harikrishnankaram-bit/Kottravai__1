                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="lg:w-1/3">
                            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 sticky top-24">
                                ...
                                <Link to="/checkout" className="w-full bg-[#8E2A8B] text-white py-4 rounded-xl font-bold hover:bg-[#701a6d] transition-all transform hover:scale-[1.02] flex items-center justify-center gap-2">
